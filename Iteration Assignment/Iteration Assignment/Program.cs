...
namespace Iteration_Assignment
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //This will ask the user for their favorite fruit and display how many times its on the list
            ...
            for (int i = 0; i < fruitsList.Count; i++)
            {
                ...
                if (userFruit != fruitsList[i]) //The counter is going to make sure it checks the whole list before displaying its not in the list
                {
                    counter2++;
                }
            ...
            //This will find duplicates in the first list and display them
            ...
            {
                foreach (string vegetableCopy in vegetableDuplicate)
                {
                    if (vegetable == vegetableCopy)
                    {
                        Console.WriteLine("This item is already in the list: " + vegetable);
                    }
                }
